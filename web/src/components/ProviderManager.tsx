...
export function ProviderManager({ onCountChange }: { onCountChange: (count: number) => void }) {
  ...
  const save = async (draft: Draft) => {
    ...
    try {
      ...
      const next = { ...toDraft(data.provider), apiKey: '' }
